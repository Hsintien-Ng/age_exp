...
from model.FusionNet import FusionNet, fusion_parameters_func
...
parameters_func = fusion_parameters_func
...
print('dataset')
train_dataset = MORPHPATCHES(index_dir=index_dir, split='train')
print('train complete')
valid_dataset = MORPHPATCHES(index_dir=index_dir, split='valid')
